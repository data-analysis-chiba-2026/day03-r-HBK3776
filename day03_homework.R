...
#comment. Rstudio distinguishes whether capital or not.
...
chr_vec <- c("LAS", "Chiba-u")
combine <- c(lgl_vec, chr_vec)

answer_6 <- typeof(combine)
...
q7 <- seq(from = 1, to = length(letters), by = 2)
answer_7 <- letters[q7]
